...
OUTPOUT_TYPE_SUM = OUTPUT_SUM + "/slim_sum/type_sum"
...
add_observable_script = utils.TOOLS_BASE_PATH + "/analysis/scripts/add_line_fit_weights_to_tree.py"
...
''')
    ...
    print("Globing", OUTPOUT_TYPE_SUM)
    ...
    for f in fileList:
        ...
        condor_f.write("error = " + OUTPUT_SUM_ERROR + "/" + filename + "_add_line.err" + "\n")
        condor_f.write("output = " + OUTPUT_SUM_OUTPUT + "/" + filename + "_add_line.out" + "\n")
